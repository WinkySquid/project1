...
public class Frame {
	 ...
	 * represent who has the current turn and the moves that the player and computer have (whether
	 ...
	 * adds the JButtons from _labMaze that represent the options that the player has. and the JLabels
	 * that represent who has the current turn and the moves that the player and computer have.
	 */
