...
public class Frame2 {
	...
	/*
	 * This method sets up all the panels required to draw a round of Rock, Paper, Scissors.
	 * It adds the labels for the cards, the score of the round, and the status of the round. It also
	 * adds the JButtons from _labMaze that represent the options that each player has.
	 */
