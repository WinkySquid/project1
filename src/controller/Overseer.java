...
public class Overseer {
	...
	/*
	 * This method displays the starting option dialog box. It sets the decoration of the dialog box,
	 * and creates a new Frame (Player vs. CPU), creates a new Frame2 (Player vs. Player), or  
	 * terminates the program depending on what option the user chooses.
	 */
	private void start() {
